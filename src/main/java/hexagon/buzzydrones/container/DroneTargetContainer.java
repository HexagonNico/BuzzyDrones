...
public class DroneTargetContainer extends Container {

    private final IInventory inventory;

    public DroneTargetContainer(int id, PlayerInventory playerInventory, IInventory inventory) {
        super(ModContainers.DRONE_TARGET, id);
        ...
        this.addSlot(new Slot(inventory, 5, 26 + 6 * 18, 20));
