...
import hexagon.buzzydrones.entity.ai.*;
...
public class DroneEntity extends CreatureEntity {
    ...
    public void die(DamageSource cause) {
        ...
        if(!cause.isCreativePlayer()) {
            if(this.type == BASIC)
                Block.popResource(this.level, this.blockPosition(), new ItemStack(ModItems.DRONE_ITEM));
            else if(this.type == PICK_UP)
                Block.popResource(this.level, this.blockPosition(), new ItemStack(ModItems.DRONE_PICKUP_ITEM));
        }
    }
