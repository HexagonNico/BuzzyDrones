...
public class DroneTargetBlock extends DroneStationBlock {

    @Override
    protected TileEntity getTileEntity() {
        return new DroneTargetTileEntity();
    }
        ...
        if(!world.isClientSide && player instanceof ServerPlayerEntity) {
            ...
            NetworkHooks.openGui((ServerPlayerEntity) player, new INamedContainerProvider() {
                ...
                public Container createMenu(int i, PlayerInventory inventory, PlayerEntity p_createMenu_3_) {
                    return new DroneTargetContainer(i, inventory, (DroneTargetTileEntity) tileEntity);
                }
